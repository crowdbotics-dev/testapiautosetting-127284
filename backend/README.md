...
## Project Structure
    ...
    ├── testapiautosetting_127284  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127284`
...
2. Clone this repo and `cd testapiautosetting_127284`
